...
import { X, Coins, Zap, ShieldCheck, Search, MessageSquare, RefreshCw } from 'lucide-react';
          ...
          <section>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              <div className="p-4 bg-gray-50 dark:bg-gray-700/30 rounded-xl border border-gray-100 dark:border-gray-700 flex flex-col items-center text-center">
                <div className="p-2 bg-green-100 dark:bg-green-900/30 rounded-lg text-green-600 dark:text-green-400 mb-2">
                  <Zap className="w-5 h-5" />
                </div>
                <div className="font-bold text-gray-900 dark:text-white">3 Кредита</div>
              ...
              <div className="p-4 bg-gray-50 dark:bg-gray-700/30 rounded-xl border border-gray-100 dark:border-gray-700 flex flex-col items-center text-center">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Текст объявления</p>
              </div>
              <div className="p-4 bg-gray-50 dark:bg-gray-700/30 rounded-xl border border-gray-100 dark:border-gray-700 flex flex-col items-center text-center">
                ...
                <div className="font-bold text-gray-900 dark:text-white">1 Кредит</div>
                <p className="text-sm text-gray-600 dark:text-gray-400">SEO Оптимизация</p>
              </div>
              <div className="p-4 bg-gray-50 dark:bg-gray-700/30 rounded-xl border border-gray-100 dark:border-gray-700 flex flex-col items-center text-center">
                <div className="p-2 bg-orange-100 dark:bg-orange-900/30 rounded-lg text-orange-600 dark:text-orange-400 mb-2">
                  <RefreshCw className="w-5 h-5" />
                </div>
                <div className="font-bold text-gray-900 dark:text-white">0.5 Кредита</div>
                <p className="text-sm text-gray-600 dark:text-gray-400">Повторная генерация</p>
              </div>
            </div>
          </section>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between p-4 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-primary-500 dark:hover:border-primary-500 transition-colors cursor-pointer group">
                <div>
                  ...
                  <div className="text-sm text-gray-500 dark:text-gray-400">15 кредитов (~15 объявлений)</div>
                </div>
              ...
              <div className="relative flex items-center justify-between p-4 rounded-xl border-2 border-primary-500 bg-primary-50/10 dark:bg-primary-900/10 cursor-pointer">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-500 dark:text-gray-400">60 кредитов (~60 объявлений)</div>
                </div>
              ...
              <div className="flex items-center justify-between p-4 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-500 transition-colors cursor-pointer">
                <div>
                  <div className="font-bold text-gray-900 dark:text-white">Business</div>
                  <div className="text-sm text-gray-500 dark:text-gray-400">200 кредитов (~200 объявлений)</div>
                </div>
                <div className="text-lg font-bold text-gray-900 dark:text-white">990 ₽</div>
              </div>
            </div>
          </section>
